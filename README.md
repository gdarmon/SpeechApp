...
Sign in with Google and choose English or Hebrew for translations. Tap **Talk**: Fala speaks a very short, easy Portuguese question and displays its translation plus two short reply ideas. Tap **Hear this answer** to hear an idea before trying it. **Hold to speak**, wait for **Listening**, then speak and release. Check or edit the words and tap **Send**. The microphone never starts automatically. You can also type a reply, adapt an idea, or explain your meaning in your chosen support language. Every answer gets a brief confirmation, one useful correction, or a clarification. After ten Portuguese answers, Fala closes the conversation and automatically prepares a summary with pointers and translated vocabulary; help requests do not advance the ten-answer count. You can also finish early. Word counts come from actual Portuguese questions, suggestions, and replies; prior exposure uses only your retained history and does not claim what you already know. A provisional assessment still needs at least five unaided spoken replies; typed or guided answers are not evidence of spontaneous speaking ability. Later conversations use your retained profile.
...
- Guided basic exchanges, immediate answer feedback, and a ten-answer session summary. The opening is capped at eight words; suggestions at seven; later spoken turns at sixteen. Assessment retains separate evidence-based dimensions. Pronunciation is unassessed without audio analysis; confidence is self-reported.
...
- Recurring mistakes counted across distinct conversations, assisted-phrase memory, next-day review context, and up to five review phrases. Summaries list translated words, how often they appeared, and whether they appeared in other retained conversations; exceptionally long older sessions show the most frequent 180 words and disclose the total.
