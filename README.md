...
Sign in with Google and choose English or Hebrew for translations. Tap **Talk**: Fala speaks first and displays the Portuguese question, its translation, and two reply ideas. **Hold to speak**, wait for **Listening**, then speak and release. Check or edit the words and tap **Send**. The microphone never starts automatically. You can also type a reply, adapt an idea, or explain your meaning in your chosen support language. Finish after at least five unaided spoken Portuguese replies for a provisional assessment; typed or guided answers are not evidence of spontaneous speaking ability. Later conversations use your retained profile.
