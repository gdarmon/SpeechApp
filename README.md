...
- Five visible practice levels with matching prompt and answer lengths, immediate feedback and a ten-answer summary. Level 1 retains the eight-word opening, seven-word ideas and sixteen-word follow-ups; higher levels gradually expand these limits. Capoeira scenarios cover directions, pace, sequences and clarification during class. An optional listen-first view and answer-idea controls support independent practice.
