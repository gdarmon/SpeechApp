...
import { lessonOpeningModel, teachingPlan } from "./pedagogy.js";
...
export const CAPOEIRA_TERMS: CapoeiraTerm[] = [
  ...
  term("corda crua", "natural, undyed beginner's cord", "חגורה התחלתית בצבע טבעי, לא צבועה"),
  term("corda crua e amarela", "natural-and-yellow cord", "חגורה בצבע טבעי וצהוב", "corda crua-amarela", "corda crua/amarela"),
  term("corda amarela", "yellow cord", "חגורה צהובה"),
  term("corda amarela e laranja", "yellow-and-orange cord", "חגורה צהובה וכתומה", "corda amarela-laranja", "corda amarela/laranja"),
  ...
  term("corda laranja", "orange cord", "חגורה כתומה"),
  term("corda laranja e azul", "orange-and-blue cord", "חגורה כתומה וכחולה", "corda laranja-azul", "corda laranja/azul"),
  term("corda azul", "blue cord; start of ABADÁ's adult graduated-student group", "חגורה כחולה — תחילת קבוצת התלמידים הבוגרים המוסמכים באבאדה"),
  term("corda azul e verde", "blue-and-green cord", "חגורה כחולה וירוקה", "corda azul-verde", "corda azul/verde"),
  ...
  term("corda verde", "green cord", "חגורה ירוקה"),
  term("corda verde e roxa", "green-and-purple cord", "חגורה ירוקה וסגולה", "corda verde-roxa", "corda verde/roxa"),
  term("corda roxa", "purple cord; ABADÁ instructor group", "חגורה סגולה — קבוצת המדריכים באבאדה"),
  term("corda roxa e marrom", "purple-and-brown cord", "חגורה סגולה וחומה", "corda roxa-marrom", "corda roxa/marrom"),
  ...
  term("corda marrom", "brown cord; ABADÁ professor group", "חגורה חומה — קבוצת המורים באבאדה"),
  term("corda marrom e vermelha", "brown-and-red cord", "חגורה חומה ואדומה", "corda marrom-vermelha", "corda marrom/vermelha"),
  term("corda vermelha", "red cord; ABADÁ mestrando group", "חגורה אדומה — דרגת מסטרנדו באבאדה"),
  term("corda vermelha e branca", "red-and-white cord; ABADÁ mestre group", "חגורה אדומה ולבנה — דרגת מסטרה באבאדה", "corda vermelha-branca", "corda vermelha/branca"),
  term("corda branca", "white cord; ABADÁ's highest graduation", "חגורה לבנה — הדרגה הגבוהה ביותר באבאדה"),
  term("batizado", "capoeira initiation ceremony", "טקס חניכה בקפואירה"),
  term("troca de cordas", "cord-changing graduation ceremony", "טקס החלפת חגורות ועליית דרגה"),
  ...
  term("sem medo", "without fear", "בלי פחד"),
...
export const CAPOEIRA_LESSONS = [
  lesson("kicks-v1", "Kicks in class", "Talk with a classmate about a kick they practise, whether it is familiar and how practice is going. Ask about their experience without teaching physical execution.", "martelo|queixada|armada|meia-lua de frente"),
  ...
  lesson("evasions-v1", "Evasions and transitions", "Talk with a classmate about familiar evasions and practice. Respond to what they do or do not know. No order has been announced; do not quiz the next movement or teach execution.", "esquiva diagonal|cocorinha|negativa|rolê"),
  ...
  lesson("sweeps-v1", "Sweeps and takedown names", "Talk with a classmate about movements they know or practise with a teacher. Allow unfamiliarity and questions. No physical execution instructions.", "rasteira|banda|tesoura|vingativa"),
  ...
  lesson("direct-kicks-v1", "More kick names", "Talk about familiar kicks and the learner's class practice. Ask about their experience without inventing today's class plan or teaching execution.", "bênção|chapa|ponteira|pisão"),
  ...
  lesson("floor-v1", "Floor movements and balances", "Talk with a classmate about floor movements they know or practise. Do not assume an unseen demonstration or ask for physical performance.", "aú|macaco|bananeira|queda de rins"),
  ...
  lesson("spinning-v1", "Spinning movement names", "Talk about a familiar spinning movement and the learner's practice. If they ask about names or variations, explain briefly without claiming all schools use the same terminology.", "meia-lua de compasso|rabo de arraia|martelo rodado"),
  ...
  lesson("demonstration-v1", "Watching a demonstration", "Chat about watching or attending a capoeira demonstration and movements the learner knows. Do not pretend a demonstration has been shown, or teach how to perform acrobatics or takedowns.", "s-dobrado|chapéu de couro|arrastão|cabeçada"),
  lesson("roda-v1", "Language around the roda", "Chat about joining or watching a roda, familiar movements and the learner's own experience. Accept that they may not know a movement; do not assume unseen action.", "ginga|volta ao mundo|roda|voo do morcego"),
  ...
  lesson("cartwheel-shapes-v1", "Recognizing cartwheel names", "Talk with a classmate about cartwheel movements they know or practise. Keep the Portuguese at the learner's level and accept unfamiliarity, even for advanced movement names. No execution instructions.", "aú aberto|aú fechado|aú sem mão"),
  lesson("cartwheel-variations-v1", "Cartwheel variations in a demonstration", "Talk about cartwheel variations the learner knows from class. Ask about their experience without requiring physical performance. Explain terminology if asked; variations differ by school.", "aú batido|aú de cabeça|aú helicóptero"),
  lesson("roda-rhythms-v1", "Talking about the rhythm of the game", "Chat with a classmate about named rhythms and the pace of the roda. Ask about rhythms they know or enjoy and respond to their experience. Angola also appears in ABADÁ; do not assume every roda uses every rhythm or quiz recognition of audio that was not played.", "são bento grande da regional|benguela|são bento pequeno|angola"),
  ...
  lesson("event-music-v1", "Music and dance at a capoeira event", "Talk with a classmate about an event's music and dance demonstrations. Cavalaria is a warning rhythm; samba de roda and maculelê are distinct dance traditions with their own music. Discuss attending an event, familiar music and preferences, without claiming a real emergency or asking the learner to identify unheard music.", "cavalaria|samba de roda|maculelê"),
  lesson("opening-songs-v1", "Talking about the opening song", "Chat with a classmate about singing in the roda and songs they know. Explain an unfamiliar term briefly when needed and continue the conversation. Louvação and chula overlap in some traditions but are not universal synonyms; do not impose one song order on every ABADÁ roda. Discuss the singing without quoting song lyrics or pretending to play music.", "ladainha|louvação|chula"),
  ...
  lesson("song-phrases-v1", "Useful phrases from capoeira song titles", "Use one of these short song-title phrases from ABADÁ Berlin as spoken practice: 'Entra na roda sem medo' or 'Deixa o berimbau falar'. Explain it briefly, then help the learner respond in an original class conversation. Use the small focus expressions naturally: a first-person answer such as 'Entro sem medo' is useful, and the learner does not have to recite a complete title. Cantar junto is an original practice expression, not a quoted lyric. Do not continue lyrics, claim ABADÁ authorship or ask the learner to sing. Ask one simple question at a time.", "sem medo|berimbau|cantar junto"),
...
export function lessonContext(choice: LessonChoice | undefined, question = 0, language = "en-US", level: unknown = 1) {
  ...
  const patterns = focus.startsWith("corda ") ? ["Tenho ...", "Ainda não tenho ..."]
    : selected.id === "instruments-v1" ? ["Toco ...", "Ainda não toco ..."]
    : ["Eu ...", "Ainda não ..."];
  return { id: selected.id, title: selected.title, school: "ABADÁ", situation: selected.situation,
    answer_frames: patterns,
    vocabulary: introduced.map(word => { const entry = capoeiraTerm(word)!; return { term: entry.word, usage: entry.word.startsWith("corda ") ? "literal cord description, not an idiom" : "use in the lesson situation; not automatically an idiom", meaning: entry.en, translation: language === "he-IL" ? entry.he : entry.en }; }),
    ...
    next_prompt: { task: plan.task, phase: plan.phase, format: plan.format, allow_repetition: plan.allow_repetition,
      ...
      model: question === 0 ? lessonOpeningModel(selected.id, focus, meaning, language, level) : undefined },
  };
}
