...
- Paid OpenAI configuration and request shapes are covered by automated tests. Live model access, response time and Portuguese/Hebrew quality remain unverified until an OpenAI API key is supplied; the current production provider is still Groq.
