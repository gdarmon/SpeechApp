...
There are 21 lesson themes: kicks, instruments, first cord colors, evasions, class exercises, sweeps, berimbau parts, direct kicks, orange/blue cords, floor movements, game instructions, spinning movements, green/purple cords, demonstrations, roda language, clapping/singing, teacher cords, ceremonies, the berimbau ensemble, cartwheel names and cartwheel variations. Each lesson supplies only three or four focus terms, with original English and Hebrew meaning notes. The learner's supplied movement lists are included, except **Meia-lua solta**, which they explicitly removed. The two cartwheel lessons have new IDs appended to the catalog, preserving existing lessons and their revisit order.
