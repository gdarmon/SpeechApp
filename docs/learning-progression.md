...
Capoeira mode role-plays classroom language: direction, speed, repetition, grouping, sequences and asking the teacher to clarify. The learner answers verbally; Fala does not observe or assess movements. The [Instituto Palmeiras glossary](https://institutopalmeiras.pbworks.com/w/page/59139299/Glossary%20of%20Capoeira%20Terms) provides examples of classroom vocabulary; terminology can differ across schools. Prompts are original, and Fala does not teach physical technique or assign a capoeira cord/rank.

## Four or five useful words

The server selects at most five actual dialogue words, favoring relevance, novelty in retained history, corrections/help phrases and repetition. Frequent function words are omitted; a small set of common inflections share a review slot. The model translates only those selected words, reducing output size. If fewer than four useful words occurred, Fala shows fewer rather than inventing fillers.
