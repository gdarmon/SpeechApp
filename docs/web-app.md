...
Share https://falachatapp.netlify.app/app/ . Web and native Android both display version 0.12.3; each is distributed separately. Netlify serves the public PWA and the same authenticated API/database. GitHub Pages alone cannot run this backend.
