...
Share https://legendary-florentine-6b3c1f.netlify.app/app/ . Web and native Android both display version 0.9.0; each is distributed separately. Netlify serves the public PWA and the same authenticated API/database. GitHub Pages alone cannot run this backend.
