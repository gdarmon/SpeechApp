...
Conversation instructions prefer short, natural Brazilian speech, one question at a time, fluency over perfection, and gradual adaptation. An unknown learner is not assigned a CEFR label. Every session begins with guided basic production, even if recognition vocabulary or an earlier estimate is high: one concrete question, at most eight Portuguese words. Suggestions have at most seven words; later spoken turns have at most sixteen. Difficulty grows only with independent conversational evidence. Assessment gathers evidence naturally without forcing past-tense or opinion questions before basic exchanges work. Estimates remain provisional. Comprehension is inferred only from responses; vocabulary, grammar, and sentence construction require quoted evidence. Pronunciation and confidence are not scored from text. Fluency notes must state the limitations of recognition timing.
