...
export function createWalkthrough({ preferences, account, language, stopAudio, onSeen = () => {} }) {
  ...
  const copy = {
    ...
    he: [
      ['מתחילים בהקשבה', 'לחצו על ״האזנה״ כדי לשמוע את השאלה בפורטוגזית. ״לאט יותר״ משמיע לאט יותר, והתרגום עוזר להבין.'],
      ...
      ['לוחצים, מדברים, משחררים', 'החזיקו את כפתור המיקרופון, חכו שיופיע ״מקשיבים״ ודברו. סיימתם? שחררו. אפשר גם להקליד.'],
