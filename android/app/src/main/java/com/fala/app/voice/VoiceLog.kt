...
enum class VoiceEvent {
    ...
    PLAYBACK_INIT, PLAYBACK_LANGUAGE, PLAYBACK_VOICE, PLAYBACK_RATE, PLAYBACK_RETRY, PLAYBACK_START, PLAYBACK_DONE, PLAYBACK_ERROR, API_ERROR
}
...
enum class VoiceOperation {
    ...
    INITIALIZE_TTS, SET_TTS_LANGUAGE, SET_TTS_VOICE, SET_TTS_RATE, REQUEST_AUDIO_FOCUS, SPEAK, PLAYBACK_CALLBACK, AWAIT_PLAYBACK
}
