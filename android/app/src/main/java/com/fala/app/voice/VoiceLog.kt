...
enum class VoiceEvent {
    ...
    PLAYBACK_INIT, PLAYBACK_LANGUAGE, PLAYBACK_START, PLAYBACK_DONE, PLAYBACK_ERROR, API_ERROR
}
...
enum class VoiceOperation {
    ...
    INITIALIZE_TTS, SET_TTS_LANGUAGE, REQUEST_AUDIO_FOCUS, SPEAK, PLAYBACK_CALLBACK
}
